...
white_turtle.penup()
white_turtle.goto(-460, 170)
white_turtle.pendown()
for i in range(6):
    speed(0)
    white_turtle.forward(918)
...
#MOVE THE  TURTLE
while blue_turtle.xcor() <= 450 and pink_turtle.xcor() <= 450 and yellow_turtle.xcor() <= 450 and green_turtle.xcor() <= 450 and red_turtle.xcor() <= 450 and black_turtle.xcor() <= 450 :
